...
The forward is called in each attention layer of the diffusion model and 
it can modify the input attnetion weights attn.

is_cross, place_in_unet in ("down", "mid", "up"), 
AttentionControl.cur_step help us track the exact attention layer and timestamp 
during the diffusion iference.
"""
...
class LocalBlend:
    ...
    def __init__(self, prompts: List[str], words: List[List[List[str]]], threshold=.3):
...
class AttentionControl(abc.ABC):
    ...
    def between_steps(self):  ## will be overwritten
        return
